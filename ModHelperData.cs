...
{
    public const string Name = "TF2 Aimbot Sniper";
    public const string Description = "Get Gud, Get this tower mod.  Disable Voice lines in the mod menu if you don't like swearing.";
